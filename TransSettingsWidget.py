...
class TransmissionSettings(QDialog):
    ...
    def __init__(self):
        ...
        self.label8 = QLabel("Image resize X,Y: ")
        ...
        self.textBox8A = QLineEdit()
        self.textBox8B = QLineEdit()
        ...
        self.small_form_layout = QGridLayout()
        ...
        self.small_form_layout.addWidget(self.textBox8A,0,0)
        self.small_form_layout.addWidget(self.textBox8B,0,1)
        ...
        self.Other_setting_form_layout.addLayout(self.small_form_layout,1,1)
    ...
    def setValues(self, transMethod, gottenAddress, gottenPort, gottenBuffer, gottenFrequency, gottenSampRate, gottenBandwidth, gottenCamPort, gottenFlip, gottenResizeX, gottenResizeY, gottenSkipValue):
        ...
        print "Current Camera port: ", gottenCamPort, " - Resize values: ", gottenResizeX, gottenResizeY, " - Skipping ", gottenSkipValue, " - Frames."
        if transMethod == 0:
            self.radio_button_0.setChecked(True)
            self.RF_group_box.setEnabled(False)
            self.LAN_group_box.setEnabled(True)
        elif transMethod == 1:
            self.radio_button_1.setChecked(True)
            self.RF_group_box.setEnabled(True)
        ...
        self.textBox8A.setText(str(gottenResizeX))
        self.textBox8B.setText(str(gottenResizeY))
    ...
    def getValues(self):
        ...
        print "New Camera port is: ", int(self.textBox7.text()), " - Resize values: ", int(self.textBox8A.text()), int(self.textBox8B.text()), " - Skipping ", int(self.textBox9.text()), " Frames."
        return self.radio_button_group.checkedId() , self.textBox1.text(), int(self.textBox2.text()), int(self.textBox3.text()), int(self.textBox4.text()), int(self.textBox5.text()), int(self.textBox6.text()),  int(self.textBox7.text()), int(self.checkBox1.isChecked()), int(self.textBox8A.text()), int(self.textBox8B.text()), int(self.textBox9.text())
